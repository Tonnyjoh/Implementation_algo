def midpoint_method(f, t0, y0, h, t_final):
    """
    Implémente la méthode du point milieu pour résoudre une équation différentielle.
...
t_values, y_values = midpoint_method(f, t0, y0, h, t_final)
